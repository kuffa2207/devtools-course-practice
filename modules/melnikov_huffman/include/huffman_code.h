...
#ifndef MODULES_MELNIKOV_A_HUFFMAN_CODE_H_
#define MODULES_MELNIKOV_A_HUFFMAN_CODE_H_
...
public:
    ...
    int MinHeap::add_node(char symbol, int freq, Node* left = nullptr, Node* right = nullptr)
    {
...
#endif  // MODULES_MELNIKOV_A_HUFFMAN_CODE_H_
